  ...
  <div class="container-fluid p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="cart.php"><i class="fa-solid fa-cart-arrow-down"></i><sup>1</sup></a>
        </li>
        <li class="nav-item">
      ...
      <div class="col-md-2 bg-secondary p-0">
        ...
        <ul class="navbar-nav me-auto text-center">
          <li class="nav-item bg-info">
            <a href="#" class="nav-link text-light"><h4>Branded-Products</h4></a>
          </li>
            <?php    
                //  calling fun()
             getbrands();
        ...
        <ul class="navbar-nav me-auto text-center">
          <li class="nav-item bg-info">
            <a href="#" class="nav-link text-light"><h4>Floor-Categories</h4></a>
          </li>
          <?php         
              getcategories();
             ?>
